  ...
  return (
    <div className='bg-[#120800] lg:h-[calc(100vh-90px)] flex flex-col lg:flex-row justify-center lg:justify-between items-center px-3 lg:px-10 xl:px-32 pt-12 md:pt-0 bg-img'>
      ...
      for our community.
        ...
        <h1 className="leading-[2rem] text-1xl  font-bold">TOGETHER, WE CAN ELEVATE OUR DEAR  CHERISHED, ANCIENT HOME OF OYA, IRA, TO ITS RIGHT PLACE OF HOURNOR. <span className="underline">IRA MAJA!</span> .
        </h1>
