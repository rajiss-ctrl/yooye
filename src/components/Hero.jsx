...
const Hero = () => {
  return (
    <div className='bg-[#120800] h-[calc(100vh-100px)] flex flex-col lg:flex-row justify-center lg:justify-between items-center px-3 lg:px-32  bg-img'>
      ...
      for our community.
        ...
        <h1 className="leading-[2rem] text-3xl font-bold">TOGETHER, WE CAN ELEVATE OUR DEAR  CHERISHED, ANCIENT HOME OF OYA, IRA, TO ITS RIGHT PLACE OF HOURNOR. <span className="underline">IRA MAJA!</span> .
        </h1>
